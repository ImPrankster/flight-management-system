...
export const airline = mysqlTable(
  "Airline",
  {
...
export const airlineStaff = mysqlTable(
  "AirlineStaff",
  {
  ...
  (table) => {
    return {
      ...
      airlineStaffUsername: primaryKey({
        columns: [table.username],
        name: "AirlineStaff_username",
      }),
    };
  },
);

export const airplane = mysqlTable(
  "Airplane",
  {
  ...
  (table) => {
    return {
      airlineName: index("airline_name").on(table.airlineName),
      airplaneIdentificationNumber: primaryKey({
        columns: [table.identificationNumber],
        name: "Airplane_identification_number",
      }),
    };
  },
);

export const airport = mysqlTable(
  "Airport",
  {
    name: varchar("name", { length: 255 }).notNull(),
...
export const bookingAgent = mysqlTable(
  "BookingAgent",
  {
...
export const flight = mysqlTable(
  "Flight",
  {
    ...
    airplaneIdentificationNumber: int(
      "airplane_identification_number",
    ).references(() => airplane.identificationNumber),
  ...
  (table) => {
    return {
      ...
      airplaneIdentificationNumber: index("airplane_identification_number").on(
        table.airplaneIdentificationNumber,
      ),
      flightFlightNumber: primaryKey({
...
export const flightPassenger = mysqlTable(
  "FlightPassenger",
  {
